                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{$blog->name}}">
                                </div>
                                <div class="col-12">
                                    <label for="description" class="form-label">Description:</label>

                                    <textarea id="description" name="description" class="form-control" rows="4" cols="50">{{$blog->name}}</textarea>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="status"class="form-control" id="status">
                                        <option value="{{$blog->status}}" class="option_colour">Select Satus</option>
